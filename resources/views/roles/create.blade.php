...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ route('roles.create') }}">Thêm</a></li>
        </ol>
    </section>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Thêm nhóm người dùng</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="{{ route('roles.store') }}" method="post">
                        ...
                        <div class="box-body">
                            <div class="form-group{{ $errors->has('role_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="role_name" name="role_name" placeholder="Tên nhóm người dùng">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                <textarea name="description" value="{{ old('description') }}"  id="description" cols="30" rows="5" placeholder="Description" class="form-control"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    @foreach($permission as $value)
                                        @if ($i % 4 == 0)
                                            <tr><td><strong>{{ strtoupper($value->object) }}</strong></td>
                                        @endif
                                        @php $i++; @endphp

                                        <td><label class="checkbox-inline"><input type="checkbox" value="{{ $value->id }}" name="permission[]"> {{ $value->display_name }}</label></td>
                                        @if ($i % 4 == 0) </tr> @endif
                                    @endforeach
