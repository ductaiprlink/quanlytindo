        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="box box-success">
                    ...
                    <form class="form-horizontal" action="{{ route('achievements.update', ['id' => $id, 'achie_id' => $achievement->id]) }}" method="post">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="date" placeholder="Ngày" name="date" value="{{ $achievement->date }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="advantage" id="advantage" cols="30" rows="3" class="form-control">{{ $achievement->advantage }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="disadvantage" id="disadvantage" cols="30" rows="3" class="form-control">{{ $achievement->disadvantage }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
